  ...
  Widget build(BuildContext context) {
    return  Scaffold(body: Column(children: [
      ...
      Row(
        ...
        children: [
        Reuseable_Contact(icon: Icons.request_quote_outlined,txt: "Request",),
        Reuseable_Contact(icon: Icons.call,txt: "Call",),
        Reuseable_Contact(icon: Icons.message,txt: "Message",),

      ],),
      Reuseable_Button(text: "Show directions",)
    ],),);
  }
}
